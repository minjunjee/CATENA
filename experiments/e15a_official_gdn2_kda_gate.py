...
DEFAULT_CONFIG = "configs/e15a_official_gdn2_kda_gate.yaml"
    ...
    report = {
        ...
        "claim_gate": {
            ...
            "allowed_claim": (
                ...
                "revision and every registered parity, state, gradient, and "
                "intervention check pass."
            ),
            "forbidden_claim": (
