...
EXPERIMENT_ID = "e15b_official_kveraser_gate"
DEFAULT_CONFIG = "configs/e15b_official_kveraser_gate.yaml"
...
def main() -> None:
    ...
    report = {
        ...
        "claim_gate": {
            ...
            "allowed_claim": (
                "Official KVEraser operator evidence only after the pinned "
                "revision and every registered recompute, state, and gradient "
                "check pass."
            ),
            "forbidden_claim": (
                "Dry-run, reference, mock, unpinned, or partially passing "
                "operators as official evidence."
            ),
        },
    }
    finalize_run(
