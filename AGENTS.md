...
## Post-core safety addendum

- Do not edit, relabel, or delete completed H1-H5 artifacts.
- Do not reopen H5 or change its SESOI/seed-direction gate.
- E10, E11, E12, and E13a may run independently.
- E13b requires an explicit E13a GO; E13c requires paired tied/dual cells; E14 requires E13c support.
- Reference results cannot be reported as official-backbone or language-model evidence.
- Every new experiment must preserve one Python entry point, one YAML config, immutable per-run artifacts, and explicit claim boundaries.
